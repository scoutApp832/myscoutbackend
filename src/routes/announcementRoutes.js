...
// ✅ GET announcements for scouts (from announcements table)
router.get('/announcements', scoutController.getAnnouncements);

// POST create announcement (National/District Commissioner only)
router.post('/announcements', notificationController.createAnnouncement);

// GET recipients for announcement
router.get('/announcements/recipients', notificationController.getRecipients);
