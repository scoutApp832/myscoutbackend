...
// ============================================
// DISTRICT CONTROLLER FOR ATTENDANCE
// ============================================
...
app.get(
  ...
  districtController.getAttendanceViaLink
);

app.post(
  '/api/attendance/:token',
  districtController.markAttendanceViaLink
);

app.get(
  '/api/public/attendance/verify/:token',
  districtController.publicVerifyAttendance
);

app.post(
  '/api/public/attendance/check-in/:token',
  districtController.publicCheckInAttendance
);

console.log(
  '✅ Public attendance routes loaded'
);
...
console.log(
  '✅ Marketplace routes mounted at /api/public and /api/admin'
);
...
console.log(
  '✅ News routes mounted at /api/admin/news'
);
...
console.log(
  '📦 ideaRoutes is array?',
  Array.isArray(ideaRoutes)
);

console.log(
  '📦 ideaRoutes keys:',
  Object.keys(ideaRoutes || {})
);
...
try {
  ...
  console.log(
    '✅ Idea routes mounted at /api/ideas'
  );
  ...
  console.log(
    '✅ Router routes:',
    ideaRoutes?.stack?.length || 0
  );
} catch (error) {
  console.error(
    '❌ Failed to mount idea routes:',
    error.message
  );
...
console.log(
  '✅ Donation routes mounted at /api/donation'
);
...
if (
  ...
  app.get(
    '/api/debug/districts-test',
    (req, res) => {
      res.json({
        success: true,
        message:
          'District routes are accessible',
  ...
  app.get(
    '/api/debug/attendance-test',
    (req, res) => {
      res.json({
        success: true,
        message:
          'Attendance routes are accessible',
  ...
  app.get(
    '/api/debug/marketplace-test',
    (req, res) => {
      res.json({
        success: true,
        message:
          'Marketplace routes are accessible',
...
const startServer = async () => {
  try {
    ...
    // IMPORTANT:
    // Keep database synchronization limited
    // to development only.
    //
    // Production Neon database is NOT altered
    // automatically here.
    ...
    app.listen(
      ...
      () => {
        ...
        console.log(
          `🔗 Ideas API: http://localhost:${PORT}/api/ideas`
        );
        ...
        console.log(
          `🔗 Ideas Test: http://localhost:${PORT}/api/ideas/test (PUBLIC)`
        );

        console.log(
          `🔗 Districts API: http://localhost:${PORT}/api/districts`
        );
        ...
        console.log(
          `🔗 Attendance API: http://localhost:${PORT}/api/attendance/:token`
        );
        ...
        console.log(
          `🔗 Marketplace API: http://localhost:${PORT}/api/public/products`
        );

        console.log(
          `🔗 News API: http://localhost:${PORT}/api/admin/news`
        );
        ...
        if (
          ...
          console.log(
            '   GET /api/debug/notifications-test - Test notifications'
          );

          console.log(
            '   GET /api/debug/attendance-test - Test attendance routes'
          );

          console.log(
            '   GET /api/debug/ideas-test - Test ideas model'
          );

          console.log(
            '   GET /api/debug/payment-test - Test payment routes'
          );

          console.log(
            '   GET /api/debug/marketplace-test - Test marketplace routes'
          );

          console.log(
            '   GET /api/debug/news-test - Test news routes'
          );

          console.log(
            '   GET /api/ideas/test - Test idea routes (PUBLIC)'
          );
        }
      }
    );
    ...
    console.error(
      '   3. Database "scoutdatabase" exists'
    );
